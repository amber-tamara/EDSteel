...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <h2 className="text-lg font-semibold mt-8 mb-2">1. Overview</h2>
      ...
      <h2 className="text-lg font-semibold mt-8 mb-2">2. Products</h2>
      <p className="text-gray-600">
      ...
      <h2 className="text-lg font-semibold mt-8 mb-2">3. Pricing</h2>
      <p className="text-gray-600">
      ...
      <h2 className="text-lg font-semibold mt-8 mb-2">4. Orders</h2>
      <p className="text-gray-600">
        We reserve the right to refuse or cancel any order at our discretion,
        including if fraud or pricing errors are suspected.
      </p>

      <h2 className="text-lg font-semibold mt-8 mb-2">5. Delivery</h2>
      <p className="text-gray-600">
      ...
      <h2 className="text-lg font-semibold mt-8 mb-2">6. Liability</h2>
      <p className="text-gray-600">
        We are not liable for any indirect, incidental, or consequential damages
        arising from the use of our products or website.
      </p>

      <h2 className="text-lg font-semibold mt-8 mb-2">7. Changes to Terms</h2>
      <p className="text-gray-600">
